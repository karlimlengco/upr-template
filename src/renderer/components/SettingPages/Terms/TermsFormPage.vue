  ...
  <div class="container">
    ...
    <div class="content">
      <div class="content__wrapper">
        <form class="ui form addcatform" @submit.prevent="addTerm">
          <div class="row">
            <div class="twelve columns align-left utility utility--align-right">
              <router-link to="terms-list-page" class="button button--pull-left" ><i class="nc-icon-mini  arrows-1_tail-left"></i></router-link>
  ...
  export default {
    ...
    methods: {
      ...
      addTerm () {
        ...
        if (!this.errors.any()) {
          this.createPaymentTerm(this.model)

          this.$root.$children[0].showNoti = true
          this.$router.push({
            path: 'terms-list-page'
          })
        }
      }
    },
