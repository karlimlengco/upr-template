  ...
  <div class="container">
    ...
    <div class="content">
      <div class="content__wrapper">
        ...
        <br>
        <h3><span style="border-bottom:2px solid black">List of Ongoing Unit Purchase Requests(UPRs)</span></h3>
...
<script>
  ...
  export default {
    name: 'upr-ongoing-list-page',
    components: { TopBar, SideBar },
    methods: {
      ...mapActions([
        'listOverviewOngoingUprs',
        'listBidOverviewOngoingUprs'
      ]),
      searchVal(msg) {
        if ( this.$route.query.pType != 'bidding') {
          this.listOverviewOngoingUprs([this.$route.query.uprProgram, this.$route.query.pccoName, this.$route.query.unitCode, this.offset, msg.searchText])
        } else {
          this.listBidOverviewOngoingUprs([this.$route.query.uprProgram, this.$route.query.pccoName, this.$route.query.unitCode, this.offset, msg.searchText])
        }
      }
    },
    mounted: function () {
      ...
      if ( this.$route.query.pType != 'bidding') {
        this.listOverviewOngoingUprs([this.$route.query.uprProgram, this.$route.query.pccoName, this.$route.query.unitCode, this.offset])
      } else {
        this.listBidOverviewOngoingUprs([this.$route.query.uprProgram, this.$route.query.pccoName, this.$route.query.unitCode, this.offset])
      }
    ...
    data () {
      return {
        ...
        offset: 0,
        pageTitle: 'Unit Purchase Request (Ongoing)'
      }
    },
    computed: {
      ...mapGetters([
